...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("01/01/2022"), "Partiu viagem", "Vou viajar pra São Paulo, Abraços!", maria);
		Post post2 = new Post(null, sdf.parse("01/08/2022"), "Bom dia", "Bom dia familia!", bob);
